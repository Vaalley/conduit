...
- [ ] Portal player files import (notepad, admin flag, lastServer becomes lastWorld) with unknown legacy fields preserved untouched; the uuid cache seeds the name cache
- [ ] Backend ops entries re-key to Mojang UUIDs and land in both the real ops list and the admin flag
