...
object EmbassyAnchors {
    ...
    fun register() {
        ...
        BlockEvents.USE_WITHOUT_ITEM.reloadable.register { _, level, pos, player, _ ->
        ...
        ServerPlayerEvents.LEAVE.reloadable.register { player -> lastBlock.remove(player.uuid) }
        ServerLifecycleEvents.SERVER_STOPPED.reloadable.register { lastBlock.clear() }
    }
