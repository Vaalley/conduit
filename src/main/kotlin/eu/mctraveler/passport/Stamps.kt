...
object Stamps {
    val ALL: List<Stamp> = listOf(
        ...
        Stamp("digger", "Digger", "Mined 1,000 blocks", "⛏️") { it.passport.blocksMined >= 1_000 },
        Stamp("excavator", "Excavator", "Mined 10,000 blocks", "🧨") { it.passport.blocksMined >= 10_000 },
        Stamp("mountain_mover", "Mountain Mover", "Mined 100,000 blocks", "🏔️") { it.passport.blocksMined >= 100_000 },
