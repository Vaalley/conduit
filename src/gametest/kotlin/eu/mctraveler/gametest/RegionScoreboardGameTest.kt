...
class RegionScoreboardGameTest {
    ...
    fun aRuntimeReloadRemovesItsObjectiveBeforeRedrawingIt(helper: GameTestHelper) {
        ...
        // Retiring the sidebar while the client remains connected must remove
        // its objective before drawing the same sidebar again.
        ...
        helper.assertValueEqual(
            ...
            "the objective packets across sidebar retirement",
        )
        alice.leave()
        helper.succeed()
    }
